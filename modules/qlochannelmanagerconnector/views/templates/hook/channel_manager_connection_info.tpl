...
<div class="row">
    ...
    <div class="col-sm-7 channel_connection_info">
        ...
        <span class="channel_info_type connection_criteria"><i id="connection_details" class="icon-info-circle" data-toggle="popover" data-content="{l s='Connection status with channel manager is showing according to the bookings fetched from TodayInTech Channel Manager.' mod='qlochannelmanagerconnector'}"></i></span>
    </div>
</div>
