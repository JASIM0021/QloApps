            ...
            <div class="qcm_info_block">
                <div class="row">
                    ...
                    <div class="connect_info_txt col-sm-12 margin-bottom-10">
                        **{l s='Connection status with channel manager is showing according to the bookings fetched from TodayInTech Channel Manager.' mod='qlochannelmanagerconnector'}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            ...
                            <ul>
                                <li>{l s='Enable TodayInTech webservice from Webservice tab.' mod='qlochannelmanagerconnector'} <a target="blank" href="{$link->getAdminLink('AdminWebservice')}"><i class="icon-external-link"></i></a></li>
                                ...
                                <li>{l s='Create account on Channel Manager' mod='qlochannelmanagerconnector'} <a target="blank" class="qcm-link" href="https://channels.qloapps.com/"><i class="icon-external-link"></i></a>. {l s=' Then enter TodayInTech webservice credentials under PMS settings of channel manager .' mod='qlochannelmanagerconnector'}</li>
                                <li>{l s='Synchronize and map TodayInTech hotels and room types in channel manager.' mod='qlochannelmanagerconnector'}</li>
                            </ul>

                            {l s='To read the connection process in detail, visit' mod='qlochannelmanagerconnector'} <a class="qcm-link" href="https://todayintech.in/contact">{l s='Connection with PMS' mod='qlochannelmanagerconnector'}</a>
                        </div>
                ...
                <div class="row flex-display">
                    ...
                    <div class="col-md-10 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            ...
                            <br>
                            {l s='TodayInTech channel manager synchronizes inventory, rates, restrictions with all connected OTA channels and automated bookings sync connected OTAs and TodayInTech PMS.' mod='qlochannelmanagerconnector'}
                        </div>
                        <div class="qcm_info_explore">
                            {l s='For channel manager information in detail' mod='qlochannelmanagerconnector'} <a class="qcm-link" href="https://todayintech.in/projects/hotel-management-system">{l s='Explore Channel Manager' mod='qlochannelmanagerconnector'}</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-11 qcm_info_wrapper">
                        ...
                        <div class="qcm_info_block_content">
                            <ul>
                                ...
                                <li>{l s='Already integrated with TodayInTech PMS that auto-synchronize inventories for the bookings created on TodayInTech PMS and connected OTA channels.' mod='qlochannelmanagerconnector'}</li>
                                <li>{l s='Getting more property impressions by travellers on the world’s leading Online Travel Agencies as well as on the TodayInTech Hotel booking website will boost your online brand visibility and returns you more reservations.' mod='qlochannelmanagerconnector'}</li>
                            </ul>
                        </div>
                        <div class="qcm_info_explore">
                            {l s='To know channel manager freatures and work-flow in details' mod='qlochannelmanagerconnector'} <a class="qcm-link" href="https://todayintech.in/projects/hotel-management-system">{l s='Visit Documentation' mod='qlochannelmanagerconnector'}</a>
                        </div>
                    </div>
                </div>
            </div>
